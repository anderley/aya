...
class Fornecedor(models.Model):
    ...
    cpf_cnpj = models.CharField(max_length=18, null=True, blank=True, verbose_name='CPF/CNPJ')
    nome_razao_social = models.CharField(max_length=100, null=True, blank=True, verbose_name='Razão social')
    ...
    whatsapp = models.CharField(max_length=11, null=True, blank=True, verbose_name='Whatsapp')
