...
from .forms import (ContaReceberDeleteForm, ContaReceberForm,
                    ContaReceberUpdateForm, ItemDeleteForm)
...
def delete_items(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request, f"{total} contas a receber deletado com sucesso!"
            )
    else:
        form = ItemDeleteForm()
...
class ContasReceberUpdateView(
    LoginRequiredMixin, SuccessMessageMixin, UpdateView
):
    model = FluxoCaixa
    form_class = ContaReceberUpdateForm
    template_name = "contas_receber/form.html"
    success_url = reverse_lazy("listar_contas_receber")
...
class ContasReceberDeleteView(
    LoginRequiredMixin, SuccessMessageMixin, DeleteView
):
    model = FluxoCaixa
    form_class = ContaReceberDeleteForm
