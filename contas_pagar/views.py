...
class ContasPagarCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
...
class ContasPagarUpdateView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    model = FluxoCaixa
    form_class = ContaPagarForm
    template_name = "contas_pagar/form.html"
    success_url = reverse_lazy("listar_contas_pagar")
